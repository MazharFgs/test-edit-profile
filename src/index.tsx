...
import { EditProfileProps, EditProfile } from "./edit-profile";
...
const factory: BlockFactory = (BaseBlockClass, widgetApi) => {
  /**
   *  <edit-profile message="world!"></edit-profile>
   */
  return class EditProfileBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): EditProfileProps {
      const attrs = this.parseAttributes<EditProfileProps>();
      return {
        ...attrs,
      };
    }
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<EditProfile {...this.props} widgetApi={widgetApi}/>, container);
    }

...
// ]}
  ...
  const handleUserDetails = () => {
    ...
    .then((response) => {
      ...
      setValue('work_location', user?.office[0]?.locality)
     ...
     <div className="edit-profile-element-div" style={{ width: "50%", float: "left",  }}>
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         <input disabled
           type="text"
           className="edit-profile-text-input"
           {...register("hr_title", { required: true })} />
         {errors.hr_title && (
       ...
       <div className="edit-profile-element-div" style={{ width: "50%", float: "left" }}>
         ...
         <input  disabled
          style={{marginLeft:-6}}
           ...
           {...register("internal_phone_number", { required: true, maxLength: 80 })} />
...
{singledataupdate &&        <select 
     ...
     <option value="he">He</option>
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         {singledataupdate && <SectorsDropDown  filteAttr={filterAttr}  practisedefault={singleProfiledata} handleSectorSelected={handleSectors} sectorsref ={register("sectors", { required: true })} ></SectorsDropDown>}
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         {singledataupdate && <CapabilitiesDropdown filteAttr={filterAttr} practisedefault={singleProfiledata} handleSelectedCapability={handleCapability} capabilityref = {register("capability", { required: true })} ></CapabilitiesDropdown>}
      ...
      <div className="edit-profile-main-sestion-discrption" style={{ width: "70%", float: "left", display: 'flex',  flexWrap: 'wrap' }}>
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         style={{marginLeft:-6,height:75,borderBottom: "1px solid"}}
           ...
           {...register("life_at_fgs", { required: true ,  onChange: (e) => {setCountLifeAtFgs(e.target.value.length)} })} />
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         style={{marginLeft:-6,height:75,borderBottom: "1px solid"}}
           ...
           placeholder="Write a short description"
           maxLength={totalTextAreaLimit}
           {...register("life_beyo_fgs", { required: true ,  onChange: (e) => {setCountLifePreFgs(e.target.value.length)} })} />
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         style={{marginLeft:-6,height:75,borderBottom: "1px solid"}}
           ...
           placeholder="Write a short description"
           maxLength={totalTextAreaLimit}
           {...register("life_pre_fgs", { required: true ,  onChange: (e) => {setCountLifePreFgs(e.target.value.length)} })} />
           <p className="edit-profile-textarea-character"> {countLifePreFgs}/{totalTextAreaLimit} </p>
         {errors.life_pre_fgs && (
           <p className="edit-profile-error">Please add comment</p>
         )}
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         <textarea
         style={{marginLeft:-6,height:75,borderBottom: "1px solid"}}
         defaultValue={singleProfiledata?.storyblokResolves?.full_bio}
           className="edit-profile-textarea"
           placeholder="Write a short description"
           maxLength={totalTextAreaLimit}
           {...register("full_bio", { required: true ,  onChange: (e) => {setCountFullBio(e.target.value.length)} })} />
       ...
       <div className="edit-profile-element-div" style={{ width: "100%", float: "left" }}>
         ...
         <textarea
           ...
           placeholder="Write a short description"
           maxLength={totalTextAreaLimit}
           {...register("internal_bio", { required: true ,  onChange: (e) => {setCountInternalBio(e.target.value.length)} })} />
